      ...
      <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl shadow-2xl w-full max-w-md border border-gray-100 dark:border-gray-800 transition-all">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input
                type="email"
                className="w-full border-2 border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 pl-11 pr-4 py-3 rounded-xl focus:border-blue-500 focus:bg-white outline-none transition-all dark:text-white"
          ...
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full border-2 border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 pl-11 pr-12 py-3 rounded-xl focus:border-blue-500 focus:bg-white outline-none transition-all dark:text-white"
                placeholder="••••••••"
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <button 
            ...
            className="flex items-center justify-center gap-2 py-2.5 border-2 border-gray-100 dark:border-gray-800 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-all font-medium text-sm dark:text-white"
          >
